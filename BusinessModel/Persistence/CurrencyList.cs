...
namespace BusinessModel {
    ...
    public sealed class CurrencyList {
        ...
        private static ReadOnlyCollection<string> _currencyCodes =  new ReadOnlyCollection<string>(InitializeCurrencyCodes());
        private static readonly ReadOnlyCollection<string> _currencyDescriptions =  new ReadOnlyCollection<string>(InitializeCurrencyDescriptions());

        #endregion

        #region Properties
        public static int Count {  get { return _currencyCodes.Count; }  }
        ...
        public static ReadOnlyCollection<string> Descriptions {
            get { return _currencyDescriptions; }
        }
        ...
        #region Init Currency Descriptions
